                    ...
                    <c:forEach var="user" items="${userLists}">
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    <img class="profile-user-img img-responsive img-circle" src="../img/user2-160x160.jpg"
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <div id="classInfo">
                                            <ul class="list-group">
                                                <li class="list-group-item" id="classId">
                                                    <b>班级ID</b> <a class="pull-right"></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </ul>
                        ...
                        <script>
                            ...
                            document.addEventListener("DOMContentLoaded", function() {
                                ...
                                document.getElementById("classSelect").addEventListener("change", function() {
                                    ...
                                    // 找到选择的班级
                                    let selectedClass = classLists.find(function(cls) {
                                        return cls.classID == selectedClassId;
                                    });

                                    if (selectedClass) {
                                        // 更新显示的班级ID
                                        document.getElementById("classId").querySelector("a").textContent = selectedClass.classID;
                                    } else {
                                        // 如果没有选择班级，清空显示的内容
                                        document.getElementById("classId").querySelector("a").textContent = "";
                                    }
                                });
                            });
                        </script>
