                        ...
                        <c:forEach var="user" items="${userLists}">
                            <c:forEach var="classes" items="${classLists}">
                                ...
                                <c:if test="${classes == classLists[0]}">
                                    ...
                                    <li id="order-cancel">
                                        <a href="${pageContext.request.contextPath}/TeacherTask/toUpdate">
                    ...
                    <div class="box-tools text-center">
                        <c:forEach var="checkin_teacher" items="${checkinListsForTeacher}">
                            <button type="button" class="btn bg-olive btn-xs"
                                    onclick='location.href="${pageContext.request.contextPath}/TeacherCheckin/callbackCheckin?checkinId=${checkin_teacher.checkinId}"'>打回</button>
                        </c:forEach>
